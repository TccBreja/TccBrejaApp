...
public class EstabelecimentoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaCerveja.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> lista, View item, int position, long id) {
                ...
                Intent intentCerveja = new Intent(EstabelecimentoActivity.this, CervejaUnicaActivity.class);
    ...
    private void carregaLista(){
        ...
        cerveja1.setNomeCerveja("Nome da Cerveja 2 - Lata");
        cerveja1.setCodigoCerveja(2);
